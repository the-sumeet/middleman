...
func (a *App) GetLogs(filterUrl string, methods, statuses, resposneTypes, rules []string, skip int) ReturnValue {
	requests, err := a.database.GetManyRequests(filterUrl, methods, statuses, resposneTypes, rules, skip)
	if err != nil {
