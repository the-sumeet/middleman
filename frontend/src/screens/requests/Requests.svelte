...
<section class="flex flex-col container px-4 mx-auto h-screen">
    
    <div class="sm:flex sm:items-center sm:justify-between">
        <h2 class="text-lg font-medium  text-white">Files uploaded</h2>

        <div class="flex items-center mt-4 gap-x-3">
            <button class="w-1/2 px-5 py-2 text-sm  transition-colors duration-200  border rounded-lg sm:w-auto hover:bg-gray-800 bg-gray-900  text-white border-gray-700">
                Download all
            </button>

            <button class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200  rounded-lg sm:w-auto gap-x-2 hover:bg-blue-500 bg-blue-600">
    ...
    <div class="max-h-full flex-1 flex flex-col mt-6">
            ...
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                <div class="overflow-hidden border  border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y  divide-gray-700">
                            ...
                            <tr>
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right  text-gray-400">
                                    <div class="flex items-center gap-x-3">
                                        <input type="checkbox" class="text-blue-500  rounded bg-gray-900 ring-offset-gray-900 border-gray-700">
                                        <span>File name</span>
                                    </div>
                                </th>

                                <th scope="col" class="px-12 py-3.5 text-sm font-normal text-left rtl:text-right  text-gray-400">
                                    File size
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 bg-gray-900">
                            <tr>
    ...
    <div class="flex items-center justify-between mt-6">
        <a href="#!" class="flex items-center px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md gap-x-2 hover:bg-gray-100 bg-gray-900 dark:text-gray-200 border-gray-700 dark:hover:bg-gray-800">
