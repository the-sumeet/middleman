<script>
    ...
    const selectedCss = "bg-gray-100 dark:bg-gray-800";
...
<button
    on:click={select}
    class="{$currentRule == rule
        ? selectedCss
        : ''} flex space-x-2 items-center w-full px-5 py-2 transition-colors duration-200 dark:hover:bg-gray-800 gap-x-2 hover:bg-gray-100 focus:outline-none"
>
